...
import AdminSubscribed from "./components/admin/subscriptions/AdminSubscribed";
  ...
  return (
    <Layout>
      <Switch>
        <PrivateRoutes
          {...props}
          path="/admin_reviews/add_review/:id"
          exact
          component={AddEditReviews}
        />
        <PrivateRoutes
          {...props}
          path="/admin_reviews/add_review"
          exact
          component={AddEditReviews}
        />
        <PrivateRoutes
        ...
        <PrivateRoutes
          {...props}
          path="/admin_services/add_service/:id"
          exact
          component={AddEditServices}
        />
        <PrivateRoutes
          {...props}
          path="/admin_services/add_service"
          exact
          component={AddEditServices}
        />
        <PrivateRoutes
        ...
        <PrivateRoutes
          {...props}
          path="/admin_rooms/add_room"
          exact
          component={AddEditRooms}
        />
        <PrivateRoutes
          {...props}
          path="/admin_rooms/add_rooms/:id"
          exact
          component={AddEditRooms}
        />
        <PrivateRoutes
        ...
        <PrivateRoutes
          {...props}
          path="/tariffs/add_tariff/:id"
          exact
          component={AdminTariff}
        />
        <PrivateRoutes
          {...props}
          path="/tariffs/add_tariff"
          exact
          component={AdminTariff}
        />
